...
const url = `https://discord.com/api/oauth2/authorize?client_id=866612813173751808&redirect_uri=http%3A%2F%2Flocalhost%3A9111%2Fauth%2Fredirect&response_type=code&scope=identify`;
